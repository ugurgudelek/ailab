...
const Paper = (props) => {
  return (
    <div className="card bg-light">
        <header className="card-header"><Link className="text-dark btn-link" to="#!">{props.name}</Link></header>
        <div className="card-body">Writers-Writers-Writers-Writers-Writers-Writers-Writers-Writers
        <a target="_blank" rel="noopener noreferrer" href={props.link}><i class="fas fa-download float-right text-dark btn-link"></i></a>
        </div>
