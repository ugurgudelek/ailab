    ...
    return (
        <section className="page-section bg-light member">
            ...
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline mobile-name">M. Fatih Demirci<br/>
                ...
                <img className="m-3 w-25 member-image" src={require("../../assets/img/team/m_fatih_demirci.jpg")} alt=""/>
            </div>
            <div className="bg-light">
                <p className="w-50 text-left inline mt-3 pl-5 mobile-info">mfdemirci@etu.edu.tr<br/><a className="text-dark" href="http://mfdemirci.etu.edu.tr/">http://mfdemirci.etu.edu.tr/</a><br/>Tel: XXX-XXX-XX-XX</p>
