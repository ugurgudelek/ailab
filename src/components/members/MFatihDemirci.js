...
const MFatihDemirci = () => {
    return (
        <section className="page-section bg-light member">
            <header className="team-header-2">M. Fatih Demirci</header>
            ...
            <div className="bg-light">
                ...
                <p className="w-50 text-left inline mt-3 border-left pl-3 border-dark pr-3">Fatih Demirci is an associate professor at Computer Engineering Department, TOBB University of Economics and Technology.

His research interests lie predominately in the area of Computer Vision, particularly with respect to object recognition, image classification, shape indexing and applied graph theory.</p>
            </div>
        </section>
    );
}
