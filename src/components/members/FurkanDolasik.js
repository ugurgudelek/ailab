    ...
    return (
        <section className="page-section bg-light member">
            ...
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline">Furkan Dolaşık<br/><span>Student</span> <hr/></h3>
                <img className="m-3 w-25" src={require("../../assets/img/team/2.jpg")} alt=""/>
            </div>
            <div className="bg-light">
                <p className="w-50 text-left inline mt-3 pl-3">furkandol0640@gmail.com <br/> if exist website <br/>  if exist tel number </p>
