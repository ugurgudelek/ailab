...
const MustafaMertKeskin = () => {
    return (
        <section className="page-section bg-light member">
            <header className="team-header-2 text-uppercase">Mustafa Mert Keskin</header>
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline mobile-name">Mustafa Mert Keskin<br/>
...
export default MustafaMertKeskin;
