...
const MustafaUcar = () => {
    return (
        <section className="page-section bg-light member">
            <header className="team-header-2 text-uppercase">Mustafa Ucar</header>
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline">Mustafa Ucar<br/>
            ...
            <div className="bg-light">
                <p className="w-50 text-left inline mt-3 pl-5">username@etu.edu.tr<br/><a className="text-dark" href="#!">http://username.etu.edu.tr/</a><br/>Tel: XXX-XXX-XX-XX</p>
