...
const FurkanKoc = () => {
    return (
        <section className="page-section bg-light member">
            <header className="team-header-2 text-uppercase">Dervis Utku Ufuk</header>
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline mobile-name">Dervis Utku Ufuk<br/>
            ...
            <div className="bg-light">
                ...
                <p className="w-50 text-left inline mt-3 border-left pl-3 border-dark pr-3 mobile-about">His thesis is about performance Optimization of JPEG 2000 Decompression for Ground Observation Satellite Operations</p>
            </div>
        </section>
    );
}
