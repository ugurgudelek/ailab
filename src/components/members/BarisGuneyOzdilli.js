    ...
    return (
        <section className="page-section bg-light member">
            ...
            <div className="bg-bis">
                <h3 className="p-6 text-left w-50 inline mobile-name">Baris Guney Ozdilli<br/>
                ...
                <img className="m-3 w-25 member-image" src={require("../../assets/img/team/barisguneyozdilli.JPG")} alt=""/>
            </div>
            <div className="bg-light">
                <p className="w-50 text-left inline mt-3 pl-5 mobile-info">bgozdilli@gmail.com</p>
